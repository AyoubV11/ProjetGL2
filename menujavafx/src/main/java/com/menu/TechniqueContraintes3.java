        ...
        while(it.hasNext()) {
            ...
            if(c.getChiffre() == 3) {
                if(c.getColonne() == 1) {
                    ...
                    try {
                        if(!((Arete)g.getCase(c.getLigne()+1, c.getColonne()+2)).checkPlus()  && !((Arete)g.getCase(c.getLigne()+2, c.getColonne()+1)).checkPlus()  && (((Arete)g.getCase(c.getLigne()+1, c.getColonne())).getEtat() != EnumEtat.TRAIT || ((Arete)g.getCase(c.getLigne(), c.getColonne()+1)).getEtat() != EnumEtat.TRAIT)) {
                            return true;
                        }
                    }catch(IndexOutOfBoundsException e) {}
